    ...
    */
    ...
    'listeners' => [
        ...
        RequestTerminated::class => [
            ...
            // Décommentez ou ajoutez ces lignes si elles n'y sont pas
            FlushAuthenticationState::class,
            FlushLocaleState::class,
            FlushQueuedCookies::class,
            FlushSessionState::class,

            // 👉 NOTRE PURGE DE BASE DE DONNÉES À LA FIN DE CHAQUE REQUÊTE
            // ✅ Maintenant c'est bon !
            \App\Listeners\PurgeTenantConnection::class,
        ],
