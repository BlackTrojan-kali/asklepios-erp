...
const DoctorAppointments = () => {
    ...
    const { 
        appointments, 
        getAppointments, 
        cancelAppointment, // Ajout de la fonction d'annulation
        loading,
        actionLoading
    } = useAppointmentStore();
    ...
    const [apptToCancel, setApptToCancel] = useState<AppointmentDto | null>(null); // Pour la confirmation d'annulation
    ...
    // Simulation d'un tableau de docteurs pour la modale multiple (le médecin ne peut se choisir que lui-même ici)
    ...
    const appointmentDatesSet = useMemo(() => {
        ...
        appointments.forEach(app => {
            if (app.scheduled_datetime && app.status !== 'CANCELLED') { // On ne colorie pas les annulés
        ...
        <div className="h-[calc(100vh-100px)] flex flex-col space-y-6 relative">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shrink-0">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-indigo-600 dark:border-indigo-500 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 px-4 py-2 rounded-lg font-medium transition-colors shadow-sm"
                    >
                        <Users size={18} />
                        Groupe
                    </button>
            ...
            <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0">
                ...
                <div className="w-full lg:w-1/3 bg-slate-50 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden h-full">
                    ...
                    <div className="p-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shrink-0">
                    ...
                    <div className="flex-1 overflow-y-auto p-5 custom-scrollbar space-y-4">
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-40 text-gray-400 dark:text-gray-500 bg-white dark:bg-gray-800/50 rounded-xl border border-dashed border-gray-300 dark:border-gray-700 p-6 text-center">
                                ...
                                <p className="text-xs mt-1">Vous êtes libre à cette date.</p>
                            </div>
                        ) : (
            ...
            <MultiPatientSchedulingModal
                ...
                currentCenterId={currentCenterId}
                doctors={currentDoctorOption} // On passe uniquement le docteur actuel
                prefilledDate={selectedDate}
            />
