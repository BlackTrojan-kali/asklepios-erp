...
const Pharmaciens = () => {
  // Hooks des stores
  const { pharmaciens, pagination, loading, getPharmaciens, deletePharmacien } =
    usePharmacienStore();

  // Récupération des succursales via ton usePharmacyStore
  const { pharmacyBranches: branches, getPharmacyBranches: getBranches } =
    usePharmacyStore();
  ...
  const [selectedPharmacien, setSelectedPharmacien] =
    useState<PharmacienDto | null>(null);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Gérez les comptes, rôles et affectations de vos pharmaciens.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <option value="vente">Caissier</option>
            </select>
          </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span className="font-bold text-slate-800 dark:text-gray-200">
                            {pharmacien.user?.first_name}{" "}
                            {pharmacien.user?.last_name || ""}
                          </span>
                      ...
                      <div className="flex justify-end items-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            handleDelete(
                              pharmacien.id,
                              pharmacien.user?.first_name || "Ce pharmacien",
                            )
                          }
                          title="Supprimer"
