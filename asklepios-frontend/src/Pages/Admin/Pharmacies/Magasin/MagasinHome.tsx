        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Inventaire de ma succursale</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Consultez et gérez les niveaux de stock de votre point de vente.</p>
                    </div>
                </div>
                            ...
                            {loading ? (
                                <tr>
                                    <td colSpan={3} className="p-8 text-center">
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-400">Chargement de votre inventaire...</p>
                                    </td>
                                </tr>
                            ) : stocks.length === 0 ? (
                                <tr>
                                    <td colSpan={3} className="p-12 text-center">
                                        <div className="flex flex-col items-center justify-center text-gray-400 dark:text-gray-500">
                                            ...
                                            <p>Aucun stock trouvé dans votre succursale pour ces critères.</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
