...
export default function __SalesHistory() {
  // --- ÉTATS DES FILTRES ---
  const [scope, setScope] = useState<"my-active-session" | "me" | "branch">(
    "my-active-session",
  );
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-gray-400">
            Consultez, filtrez et réimprimez les tickets de caisse de la
            pharmacie.
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-xs border border-slate-200 dark:border-gray-700 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-4 items-end">
          ...
          <div className="md:col-span-3">
            ...
            >
              <option value="my-active-session">Ma session active</option>
              <option value="me">Mes ventes (7 jours)</option>
              <option value="branch">Toutes les ventes de la succursale</option>
            </select>
          </div>
          ...
          <div className="md:col-span-0.5 flex justify-end">
            <button
              ...
              className="w-full bg-slate-100 hover:bg-slate-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-slate-700 dark:text-gray-250 font-bold py-2 px-3 rounded-xl flex items-center justify-center gap-1.5 transition-colors text-xs cursor-pointer"
