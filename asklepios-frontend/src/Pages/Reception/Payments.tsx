    ...
    getPayments(
      page,
      {
        center_id: selectedCenter?.value
          ...
          : undefined,
        invoice_id: searchInvoiceId
          ? Number(searchInvoiceId.replace(/\D/g, ""))
          : undefined,
      },
      perPage,
    );
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col lg:flex-row items-center gap-4">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-slate-800 hover:bg-slate-900 dark:bg-gray-700 dark:hover:bg-gray-600 text-white px-4 rounded-lg font-medium text-sm transition-colors"
          >
            Chercher
          </button>
          {searchInvoiceId && (
            <button
              ...
              className="bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-800 dark:text-gray-300 dark:border dark:border-gray-600 dark:hover:bg-gray-700 px-4 rounded-lg font-medium text-sm transition-colors"
            >
              Effacer
            </button>
          )}
